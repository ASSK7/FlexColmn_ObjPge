		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Online Kart",
									"targetURL": "#comdponlinekart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdponlinekart-display": {
								"semanticObject": "comdponlinekart",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.dp.onlinekart",
									"url": sap.ui.require.toUrl("com/dp/onlinekart")
								}
							}
						}
					}
